...
import MenuCard from "@/app/Components/userComponents/menuCard";
import UserOrderHistory from "@/app/Components/userComponents/userOrderHistory";
import FeedbackList from "@/app/Components/userComponents/feedbackList";
import UserCarts from "@/app/Components/userComponents/userCarts";
import "./styles.css";
...
const UserPage = () => {
  ...
  const phrases: string[] = [
    "Welcome " + userName + "!", 
    "You are Awesome!",
    "Hungry? You're at the Right Place!",
    "Feed Your Cravings!",
    "Savor Every Bite!",
    "Come Hungry again!",
  ];
  ...
  return (
    <div className="w-full h-full bg-black text-white">
      ...
      <div className="flex flex-col w-full p-5 h-full flex-wrap">
        <div
          className="text-4xl flex justify-center content-center align-middle w-full h-30 welcomeSeller flex-wrap text"
          ref={textRef}
        >
